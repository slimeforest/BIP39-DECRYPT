...
class EncryptViewController: ViewController, UITextFieldDelegate {
    ...
    @IBOutlet weak var copyButtinOutlet: UIButton!
    ...
    func textFieldDidChangeSelection(_ textField: UITextField) {
        ...
        let encryptedWord = logicBrain.encrypt(enteredWord)
        
        if encryptedWord == "Not Found" {
            mainWordLabelOutlet.text = "Not Found"
        }else {
            mainWordLabelOutlet.text = encryptedWord
        }
